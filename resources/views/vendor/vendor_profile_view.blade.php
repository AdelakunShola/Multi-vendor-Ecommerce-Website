								...
								<div class="card">
                                    ...
                                    <form method="post" action="{{ route('vendor.profile.store') }}" enctype="multipart/form-data">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" name="twitter" class="form-control" value="{{ $vendorData->twitter }}" />
											</div>
										</div>
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" name="facebook" class="form-control" value="{{ $vendorData->facebook }}" />
											</div>
										</div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            ? url('upload/vendor_images/'.$vendorData->photo):url
                                            ('upload/no_image.jpg') }}" alt="Vendor" 
