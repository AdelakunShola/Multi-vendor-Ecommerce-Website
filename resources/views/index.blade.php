...
<div class="row">
    ...
    <div class="form-group col-md-12">
        ...
        name="old_password" type="password" id="current_password"    placeholder="Old Password"  />
      ...
      <div class="form-group col-md-12">
        ...
        name="new_password" type="password" id="new_password"   placeholder="New Password"  />
      ...
      <div class="form-group col-md-12">
        ...
        type="password" id="new_password_confirmation"  placeholder="Confirm New Password"  /> 
