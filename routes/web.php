...
Route::post('/admin/update/password', [AdminController::class, 'UpdatePassword'])->name('update_password');
...
Route::post('/vendor/update/password', [VendorController::class, 'UpdatePassword'])->name('update_password_vendor');
    ...
    Route::controller(VendorProductController::class)->group(function(){
        ...
        Route::post('/vendor/update/product/thumbnail' , 'VendorUpdateProductThabnail')->name('vendor.update.product.thumbnail');
...
Route::controller(AdminController::class)->group(function(){
    ...
    Route::get('/active/vendor/detials/{id}' , 'ActiveVendorDetails')->name('active.vendor.details');
